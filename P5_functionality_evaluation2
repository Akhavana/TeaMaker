...
const unsigned long BREW_TIME = 15000000; // 15 seconds
const unsigned long TEA_DONE_TIME = 10000000; // 10 seconds
const unsigned long SCALE_READ_TIME = 200000; // 200 ms

// Timer flags
volatile bool scaleReadComplete = false;
volatile bool brewTimeComplete = false;
...
void loop() {
  switch (state) {
    ...
    //   timerStart(timer2);  // Start brew timer
      
    //   if (brewTimeComplete) {
    //     brewTimeComplete = false;
    //     state = 6;
    //   }
    //   // startAlarmTimer(timer0);
    //   // delay(15000);
    //   /*if (brewedTeaFlag) {
    //     brewedTeaFlag = false;
    //     startTea();
    ...
    //   timerStart(timer3);  // Start tea done timer
